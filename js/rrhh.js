document.addEventListener('DOMContentLoaded', () => {
  ...
  function cargarEmpleados() {
    tablaInfo.innerHTML = `<tr><td colspan="6">Cargando...</td></tr>`;
    apiFetch('/empleados')
      .then(res => res.json())
      .then(data => {
        empleados = data;
      ...
      .catch(() => {
        tablaInfo.innerHTML = `<tr><td colspan="6">Error al cargar empleados</td></tr>`;
      });
  }
  ...
  function renderInfoEmpleados(filtro) {
    ...
    if (!lista.length) {
      tablaInfo.innerHTML = `<tr><td colspan="6">No se encontraron empleados</td></tr>`;
      return;
    }
